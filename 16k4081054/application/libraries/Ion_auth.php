...
class Ion_auth
{
	...
	public function is_giaovien($id = FALSE)
	{
		$this->ion_auth_model->trigger_events('is_giaovien');

		$giaovien_group = $this->config->item('giaovien_group', 'ion_auth');

		return $this->ion_auth_model->in_group($giaovien_group, $id);
	}
