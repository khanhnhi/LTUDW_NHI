<?php echo form_open('user/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		<label for="forgotten_password_selector" class="col-md-4 control-label">Forgotten Password Selector</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="activation_selector" class="col-md-4 control-label">Activation Selector</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="remember_selector" class="col-md-4 control-label">Remember Selector</label>
		<div class="col-md-8">
